...
<div class="row">
    <div class="container">
        ...
        <div class="container text-left">
            <a href="<%=request.getContextPath()%>/album/new" class="btn btn-success">Add New Album</a>
        </div>
        <br>
        <table class="table table-bordered">
            ...
            <c:forEach var="album" items="${listAlbum}">
                <tr>
                    ...
                    <td>
                        <c:out value="${album.year}" />
                    </td>
                    <td><a href="${pageContext.request.contextPath}/album/edit?id=<c:out value='${album.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/album/delete?id=<c:out value='${album.id}' />">Delete</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
