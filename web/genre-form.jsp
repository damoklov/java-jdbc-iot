        ...
        <div class="card-body">
            ...
            <form action="update" method="post">
                ...
                <form action="insert" method="post">
                    ...
                    <c:if test="${genre != null}">
                        <input type="hidden" name="id" value="<c:out value='${genre.id}' />" />
                    </c:if>

                    <fieldset class="form-group">
                        <label>Genre Name</label> <input type="text" value="<c:out value='${genre.name}' />" class="form-control" name="name" required="required">
                    </fieldset>
